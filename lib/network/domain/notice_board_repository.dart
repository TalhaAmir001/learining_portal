...
class NoticeBoardRepository {
  ...
  static Future<List<SendNotificationDataModel>> getSendNotifications({
    ...
    try {
      ...
      if (response['success'] == true && response['notifications'] != null) {
        ...
        return list
            .map((e) => SendNotificationDataModel.fromJson(
                  e as Map<String, dynamic>,
                ))
            .where((n) => n.isActiveBool)
            .toList();
      }
      return [];
    } on ApiException catch (e) {
      debugPrint('NoticeBoardRepository: getSendNotifications ApiException: ${e.message}');
      return [];
    } catch (e) {
  ...
  static Future<bool> markNotificationAsRead({
    ...
    try {
      ...
      debugPrint('NoticeBoardRepository: markNotificationAsRead ApiException: ${e.message}');
      return false;
    } catch (e) {
