...
function getUserConnections($chat_user_id)
{
    ...
    $sql = "SELECT 
                ...
                (SELECT COUNT(*) FROM fl_chat_messages m0 WHERE m0.chat_connection_id = cc.id AND m0.chat_user_id = '$chat_user_id' AND (m0.is_read = 0 OR m0.is_read = false)) as unread_count
